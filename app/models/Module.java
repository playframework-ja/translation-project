...
public class Module implements Comparable<Module> {
    ...
    public Module(Map<String, Object> outerMap) {
        ...
        this.description = DocumentParser.parseTextile((String) outerMap.get("description"));
        this.url = (String) outerMap.get("url");
        this.author = (String) outerMap.get("author");

        this.versions = new ArrayList<Version>();

        List<Map<String, Object>> innerMap = (List<Map<String, Object>>) outerMap.get("versions");

        if (innerMap != null) {
            for (Map<String, Object> version : innerMap) {
                versions.add(new Version((String) version.get("version"), (String) version.get("publishedAt"),
