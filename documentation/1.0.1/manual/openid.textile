...
"OpenID":http://openid.net/OpenID は、オープンで非集中的な個人認証システムです。特別なユーザ情報を保持せずに、新しいユーザをアプリケーションに容易に迎え入れることができます。必要なのは、認証されたユーザを **OpenID** を通じて追跡し続けることだけです。
...
**play.libs.OpenID** クラスで提供される OpenID の機能は、 [[http://code.google.com/p/openid4java/|OpenID4Java]] を使ってビルドされています。
