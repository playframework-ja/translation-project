...
事実上、Play! アプリケーションはどこにでもデプロイすることができます: サーブレットコンテナの中や、スタンドアロンサーバとして、または Google App Engine、Stax、クラウドにもデプロイすることができます。

最も人気があるデプロイオプションは以下の通りです:。

# "スタンドアロン Play アプリケーション":deployment#aStandalonePlayapplicationa
# "アプリケーションサーバ":deployment#aApplicationserversa
# "Google App Engine":deployment#aGoogleApplicationEngineGAEa
# "Stax クラウドホスティングプラットフォーム":deployment#aStaxcloudhostingplatforma

h2. <a>スタンドアロン Play! アプリケーション</a>
...
p(note). アプリケーションサーバが展開された war ファイルをサポートしていることを確認してください。
...
h2. <a>Stax クラウドホスティングプラットフォーム</a>
