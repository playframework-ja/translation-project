...
ブログのモデル定義にもうひとつオブジェクトを追加します。Tag クラス自体は本当にとてもシンプルです:
...
さて、今すぐブログで使うつもりはありませんが、いくつかの指定されたタグでタグ付けをされた投稿を検索するとしたら、どうするのでしょうか？それは見かけより難しいです。
