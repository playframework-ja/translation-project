...
p(note). ここでは render("Admin/form.html") のショートカットとして render("@form") を使用しています。このショートカットは、単に form アクションのデフォルトテンプレートを使用するよう play に告げています。
...
初めに、 **Admin.form** で存在する投稿を検索する必要があります:
