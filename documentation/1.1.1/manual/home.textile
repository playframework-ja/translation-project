...
"バージョン 1.1.1 リリースノート":releasenotes-1.1.1 を確認してください。
...
**'Yet Another Blog Engine'** を最初から最後までコーディングすることで Play について学びます。
各章は Play の更なるクールな機能について学ぶ機会となるでしょう。
...
新しいバージョンの Play には、いくつかの変更点が含まれます。 "Play 1.1.1":releasenotes-1.1.1, "Play 1.1":releasenotes-1.1, "Play 1.0.3":releasenotes-1.0.3, "Play 1.0.2":releasenotes-1.0.2, そして "Play 1.0.1":releasenotes-1.0.1 のリリースノートを確認してください。
