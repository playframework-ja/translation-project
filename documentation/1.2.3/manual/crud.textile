...
p(note). **Tenga en cuenta** que no es obligatorio utilizar el archivo de rutas por defecto. Puede definir sus propias rutas, o también mezclarlos ambos enfoques.
...
Agrega estas líneas al archivo @conf/messages@ de su aplicación:
...
Esto copiará la plantilla por defecto @list.html@ de CRUD a la plantilla @Users/list.html@ de nuestra aplicación, sobreescribiéndolo si estuviese presente.

Ahora podrá personalizar la platilla editándola de la siguiente manera:
...
También puede agregar columnas o inputs de formulario definiendo tus propios manejadores: 
