...
Ruta 'atrapa todo' o comodín. En el archivo de routes que puedes encontrar en @conf/routes@, por defecto viene definida una ruta genérica 'catch all' que coincidirá con cualquier acción de cualquier controlador. La ruta en cuestión es la siguiente:
