...
Ahora si abre una página de la aplicación, la consola Play mostrará tres advertencias porque aún ha definido ningún archivo de mensajes localizados: 
...
bc. views.main.tools.login = Regístrese para escribir algún mensaje 
