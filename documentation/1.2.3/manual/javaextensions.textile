...
Note que en la salida no se escapa el contenido HTML, por lo que el tag @br@ no estará escapado en la salida. Esto significa decir que probablemente usted quiera utilizar "escape()":#escape para las entradas del usuario:
...
h2. <a name="string">Extensiones de String</a>
...
h2. <a name="string-array">Extensiones de arrays de cadenas</a>
