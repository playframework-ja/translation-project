...
El framework Play es una alternativa simple a la sobrecargada plataforma para desarrollo de aplicaciones empresariales de Java. Se concentra en la productividad del desarrollar y apunta a arquitecuras de aplicaciones RESTful. Play es el complemento perfecto para las *metodologías de desarrollo ágiles*.
