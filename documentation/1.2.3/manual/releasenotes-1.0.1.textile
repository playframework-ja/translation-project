...
Puede leer acerca de los bugs corregidos en la "página de avances de la versión 1.0.1":http://www.playframework.org/roadmap/1.0.1. Los cambios más importantes están mencionados en esta página:

h2. <a>Reemplazo (escape) automático de código HTML en las plantillas</a>

Ahora todas las expresiones dinámicas son reemplazadas (escaped) en el motor de plantillas para evitar ataques XSS en su aplicación. Así que si la variable **title** contiene **==&lt;h1>Title&lt;/h1>==** es reemplazada:
