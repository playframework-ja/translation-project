...
h2. <a name="java">Lée la documentación</a>

La forma más fácil de colaborar con la traducción de la documentación de Play, es leyendo la documentación en español, y sugiriendo correcciones y mejoras en los comentarios. Para aquéllos que tienen conocimientos de ingleś, sin duda resultará engorroso consultar una documentación que, inevitablemente, no podrá sonar tan natural o idiomática como la original, pero es una manera de mejorar la calidad de la traducción y permitir que otros usuarios puedan interiorizarse en el funcionamiento del framework.

h2. <a name="java">Colabora con el proyecto a través de github</a>

Al igual que la documentación original de Play!, este proyecto se encuentra disponible en el repositorio "https://github.com/opensas/playdoces":https://github.com/opensas/playdoces de github. Puede obtener el código  
...
"nada compartido (share nothing)":http://zef.me/883/the-share-nothing-architecture 
...
h2. <a>TDD - Desarrollo guidado por pruebas (si así lo desea)</a>
