...
p(note). La documentación está almacenada en formato "textile":http://en.wikipedia.org/wiki/Textile_(markup_language%29, que es un formato muy simple, pensado para que pueda ser leido y editado por seres humanos. De todas maneras, no necesitas saber textile para traducir la documentación, simplemente debes traducir el texto sin alterar el formato del texto.
