...
Utilice el "glosario":glosary#authenticityToken
...
Como ya hemos dicho, nuestra intención es lograr que la versión en castellano de la documentación de Play sea precisa y al mismo tiempo de amena lectura. Existen numerosos términos técnicos cuya traducción, lejos de aportar claridad, dificultan la comprensión del texto. En tales casos, sugerimos dejarlo en el idioma original o, en caso de requerir alguna explicación extra, utilizar el glosario de la siguiente manera:
