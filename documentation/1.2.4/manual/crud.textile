...
Para personalizar ésta vista, necesitamos crear la plantilla (template) @/app/views/Users/list.html@ en nuestra aplicación.
...
El módulo CRUD muestra las listas como un campo de texto. En éste campo de texto, la lista está representada como una lista de Strings separadas por comas. Por ejemplo:
