...
La sección @require@ muestra una lista de todas las dependencias necesarias para tu aplicación. Aquí, la nueva aplicación solo depende de **Play versión 1.2**. Pero imaginemos que tu aplicación necesita "Google Guava":http://code.google.com/p/guava-libraries/; tendríamos:
...
h3. Mantiene los directorios lib/ y modules/ sincronizados
...
Para mantener los directorios @lib/@ y @modules/@ sincronizados con el sistema de administración de dependencias, puedes agregar la opción @--sync@ al comando @dependencies@:
