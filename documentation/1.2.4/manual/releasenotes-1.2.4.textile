...
複合IDはFixturesでサポートされました。モデルとFixtureで次のアノテーションもサポートされました。 <code>@IdClass</code>, <code>@EmbeddedId</code> . より詳しくは  "hibernate documentation":http://docs.jboss.org/hibernate/annotations/3.5/reference/en/html/entity.html#d0e2177 を参照してください。
