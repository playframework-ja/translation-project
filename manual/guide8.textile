...
これで "http://localhost:9000/logout":http://localhost:9000/logout へ行き、ログアウトしてから、 **bob@gmail.com/secret** のように、 **initial-data.yml** からインポートしたユーザのどれかひとつを使ってログインを試してみることができます。
