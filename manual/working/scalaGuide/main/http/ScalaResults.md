...
-->
テキストベースの HTTP レスポンスについては、charset を適切に処理することがとても重要です。Play はデフォルトで `utf-8` を使い、この処理を行います([UTF-8を使う理由](http://www.w3.org/International/questions/qa-choosing-encodings#useunicode)参照)。
